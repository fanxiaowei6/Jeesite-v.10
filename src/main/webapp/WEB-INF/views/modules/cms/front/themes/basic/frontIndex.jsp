...
<head>
	...
	<meta name="description" content="Java ${site.description}" />
	<meta name="keywords" content="Java ${site.keywords}" />
</head>
<body>
    <div class="hero-unit" style="padding-bottom:35px;margin:10px 0; background-image: ../images/userinfobig.jpg" >
