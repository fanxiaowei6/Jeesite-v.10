...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/crv/model/?pageNo='+n+'&pageSize='+s;
        }
	...
	<script type="text/template" id="categoryBox">
		<form id="categoryForm" action="${ctx}/crv/model/updateCategory" method="post" enctype="multipart/form-data"
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crv/model/">模型管理</a></li>
		<li><a href="${ctx}/crv/model/create">新建模型</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/crv/model/" method="post" class="breadcrumb form-search">
			...
			<c:forEach items="${page.list}" var="model">
				<tr>
					...
					<td>
						...
						<a href="${ctx}/crv/model/deploy?id=${model.id}" onclick="return confirmx('确认要部署该模型吗？', this.href)">部署</a>
						<a href="${ctx}/crv/model/export?id=${model.id}" target="_blank">导出</a>
	                    <a href="${ctx}/crv/model/delete?id=${model.id}" onclick="return confirmx('确认要删除该模型吗？', this.href)">删除</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
