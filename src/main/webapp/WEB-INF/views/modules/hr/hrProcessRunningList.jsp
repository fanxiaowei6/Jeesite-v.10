...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/hr/process/running/?pageNo='+n+'&pageSize='+s;
        }
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hr/process/">流程管理</a></li>
		<li><a href="${ctx}/hr/process/deploy/">部署流程</a></li>
		<li class="active"><a href="${ctx}/hr/process/running/">运行中的流程</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/hr/process/running/" method="post" class="breadcrumb form-search">
				...
				<tr>
					...
					<td>
						<shiro:hasPermission name="act:process:edit">
							<a href="${ctx}/hr/process/deleteProcIns?procInsId=${procIns.processInstanceId}&reason=" onclick="return promptx('删除流程','删除原因',this.href);">删除流程</a>
						</shiro:hasPermission>&nbsp;
					</td>
				</tr>
			</c:forEach>
