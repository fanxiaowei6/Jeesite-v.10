...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/hr/process/deploy/">部署流程</a></li>
		<li><a href="${ctx}/hr/process/running/">运行中的流程</a></li>
	</ul><br/>
	<sys:message content="${message}"/>
	<form id="inputForm" action="${ctx}/hr/process/deploy" method="post" enctype="multipart/form-data" class="form-horizontal">
