		...
		$(document).ready(function(){
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					loading('正在提交，请稍等...');
					form.submit();
					setTimeout(function(){location='${ctx}/hr/model/'}, 1000);
				},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/hr/model/">模型管理</a></li>
		<li class="active"><a href="${ctx}/hr/model/create">新建模型</a></li>
	</ul><br/>
	<sys:message content="${message}"/>
	<form id="inputForm" action="${ctx}/hr/model/create" target="_blank" method="post" class="form-horizontal">
