...
<head>
	...
	<script type="text/javascript">
		...
		function page(n,s){
        	location = '${ctx}/hr/model/?pageNo='+n+'&pageSize='+s;
        }
	...
	<script type="text/template" id="categoryBox">
		<form id="categoryForm" action="${ctx}/hr/model/updateCategory" method="post" enctype="multipart/form-data"
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/hr/model/">模型管理</a></li>
		<li><a href="${ctx}/hr/model/create">新建模型</a></li>
	</ul>
	<form id="searchForm" action="${ctx}/hr/model/" method="post" class="breadcrumb form-search">
		...
		<tbody>
			<c:forEach items="${page.list}" var="model">
				<tr>
					...
					<td>
						<a href="${pageContext.request.contextPath}/hr/process-editor/modeler.jsp?modelId=${model.id}" target="_blank">在线设计</a>
